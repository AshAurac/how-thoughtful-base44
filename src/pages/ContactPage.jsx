...
import { Heart, Mail, Instagram, Twitter, Send } from 'lucide-react';
      ...
      <nav className="sticky top-0 z-50 bg-sand-50/90 backdrop-blur-xl border-b border-sand-300 px-6 py-4">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link to="/about" className="text-sm font-heading font-semibold text-ink-soft hover:text-ink transition-all">About</Link>
            <Link to="/contact" className="text-sm font-heading font-semibold text-ink">Contact</Link>
            <button
